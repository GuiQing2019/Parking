    ...
    <ul class="siderbar">
        ...
        <li><span>系统信息管理</span>
            <ul>
                ...
                <li><a href="<%=path %>/user?method=findPageUser" target="mainFrame">管理角色信息</a></li>
                <li><a href="<%=path %>/Admin/UserAdd.jsp" target="mainFrame">添加用户信息</a></li>
                <li><a href="<%=path %>/user?method=queryAllUser" target="mainFrame">管理用户信息</a></li>
            </ul>
        </li>
        <li><span>车位信息管理</span>
            <ul>
                <li><a href="<%=path %>/Admin/SeatAdd.jsp" target="mainFrame">添加车位信息</a></li>
                <li><a href="<%=path %>/seat?method=queryAllSeat" target="mainFrame">管理车位信息</a></li>
            </ul>
        </li>
        <li><span>IC卡信息管理</span>
            <ul>
                <li><a href="<%=path %>/Admin/CardAdd.jsp" target="mainFrame">添加IC卡类型</a></li>
                <li><a href="<%=path %>/card?method=queryAllCard" target="mainFrame">管理IC卡类型</a></li>
            </ul>
        </li>
        ...
        <li><span>留言信息管理</span>
            <ul>
                <li><a href="<%=path %>/User/MsgAdd.jsp" target="mainFrame">添加留言信息</a></li>
                <li><a href="<%=path %>/MsgHandle?type=4" target="mainFrame">管理留言信息</a></li>
            </ul>
        </li>
        <li><span>系统功能操作</span>
            <ul>
                <li><a href="<%=path %>/Common/ChagePwd.jsp" target="mainFrame">修改密码</a></li>
                <li><a href="<%=path %>/Common/UserInfo.jsp" target="mainFrame">个人信息</a></li>
                <li><a href="<%=path %>/Common/Logout.jsp">退出系统</a></li>
            </ul>
        </li>
    </ul>
